      ...
      <body style={{ overflow: 'hidden' }}>
        ...
        {/* Sección de "Nuestra historia" */}
            <div class="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                <div class="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 class="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 pb-4">Nuestra historia</h1>
                    <p class="font-normal text-base leading-6 text-gray-600">Después de la derrota del Señor del Fuego, el mundo entró en una era de paz y colaboración. A medida que las naciones comenzaron a reconstruir y fortalecer sus lazos, la necesidad de un transporte seguro, eficiente y respetuoso con el medio ambiente se hizo evidente. Así nació Acarreos Appa, una empresa que se compromete a conectar a las personas y sus bienes de una manera que honra a la naturaleza y la tradición.</p>
                </div>
                <div class="w-full lg:w-8/12 lg:pt-8">
                  <div class="grid md:grid-cols-2 lg:grid-cols-2 gap-4 justify-center items-center">
                    <div class="p-4 pb-6 flex flex-col justify-center items-center">
                      ...
                      <p class="font-medium text-xl leading-5 text-gray-800 mt-4">Sebastián Valencia Zapata</p>
                      <p class="font-normal text-base leading-5 text-gray-600">Ingeniería de Sistemas e Informática</p>
                      <p class="font-normal text-base leading-5 text-gray-600">Universidad Nacional de Colombia</p>
                    </div>
                    <div class="p-4 pb-6 flex flex-col justify-center items-center">
                      ...
                      <p class="font-medium text-xl leading-5 text-gray-800 mt-4">Alejandra Uribe Sierra</p>
                      <p class="font-normal text-base leading-5 text-gray-600">Ingeniería de Sistemas e Informática</p>
                      <p class="font-normal text-base leading-5 text-gray-600">Universidad Nacional de Colombia</p>
                    </div>
                  </div>
