            ...
            <div className="w-full lg:w-8/12 lg:pt-8">
              <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-4 justify-center items-center">
                <div className="p-4 pb-6 flex flex-col justify-center items-center">
                  <img className="w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full"
                    src="https://media.licdn.com/dms/image/v2/C4D03AQHDDzmJEZNASg/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1584502344167?e=1729123200&v=beta&t=swSUE1N3Pg8Kqavcw_lt3IU7KsuDeSbJ6-qJZ28_hWo"
                    alt="Sebastián Valencia Zapata" />
                ...
                <div className="p-4 pb-6 flex flex-col justify-center items-center">
                  <img className="w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full" 
                  src="https://media.licdn.com/dms/image/v2/D4E03AQGHF1gLkJq2kg/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1723481508775?e=1729123200&v=beta&t=zTd_tjUR5OQplzXj21jJ5xS3aQHm8PsC6QPhiLMtbkc" 
                  alt="Alejandra Uribe Sierra" />
                  <p className="font-medium text-xl leading-5 text-gray-800 mt-4">
