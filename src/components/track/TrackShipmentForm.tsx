    ...
    <>
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label
            htmlFor="guideCode"
            className="block text-sm font-semibold leading-6 text-gray-950"
          >
            Código de guía
          </label>
          <div className="mt-2.5">
            <input
              ...
              required
              type="number"
              className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-950 shadow-sm
                ring-1 ring-inset ring-gray-300 placeholder:text-gray-400
                focus:ring-2 focus:ring-inset focus:ring-yellow-950 sm:text-sm sm:leading-6"
            />
          </div>
        </div>
        ...
        <button
          type="submit"
          className="block w-full rounded-md bg-yellow-950 px-3.5 py-2.5 text-center text-sm 
            font-semibold text-white shadow-sm hover:bg-yellow-900 focus-visible:outline 
            focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-950"
        >
          Consultar
        </button>
      </form>
